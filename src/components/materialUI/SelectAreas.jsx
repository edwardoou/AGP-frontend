...
const SelectAreas = ({ name, options, ...otherprops }) => {
  ...
  return (
    <TextField {...configSelect}>
      {options.map((elemento) => (
        <MenuItem key={elemento.idareas} value={elemento.idareas}>
          {/* Preguntar si dejarlo asi o separarlo */}
          {elemento.nombre} - {elemento.sede} - {elemento.empresa}
        </MenuItem>
      ))}
      ;
    </TextField>
